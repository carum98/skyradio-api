...
import { ReportSchemaSellers, ReportSchemaSimsProvider, ReportsSchemaClients, ReportsSchemaInventory, ReportsSchemaModels } from '@models/reports.model'
...
export class ReportsRouter extends RouterCore {
    constructor (datasource: DataSource) {
        ...
        this.post({
            name: '/inventory',
            handler: controller.inventory,
            middlewares: [
                requestMiddleware({
                    body: ReportsSchemaInventory
                })
            ]
        })
